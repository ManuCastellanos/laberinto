...
class TestJuego(unittest.TestCase):
    def setUp(self):    
        ...
        archivo= os.path.join(dir, 'laberinto/JSON/4hab4bichos2bom.json')
        director= Director()
    ...
    # Assert that the habitaciones have the correct types
        ...
        self.assertEqual(hab1.hijos[0].esBomba(), True)
        self.assertEqual(hab2.hijos[0].esCornucopia(), True)
        self.assertEqual(hab3.hijos[0].esBomba(), True)
    ...
    def testCompis(self):
        self.assertEqual(len(self.juego.compañeros), 0)
